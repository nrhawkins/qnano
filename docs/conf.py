...
# -*- coding: utf-8 -*-
#
# qnano documentation build configuration file, possible to be created by
# sphinx-quickstart.
#
...
latex_documents = [(master_doc, "qnano.tex", "qnano Documentation", "Q Nano", "manual")]
...
man_pages = [(master_doc, "qnano", "qnano Documentation", [author], 1)]
